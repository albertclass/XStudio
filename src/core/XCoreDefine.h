...
/// Class ID
///                         v之后为一组自定义数值
/// Class ID的命名规则，0x 00 00 00 00
///                      ^用于标记库层次
///                       ^用于标记继承深度（继承深度现设为最大十六层）
#define	TypeXObject						xClassType(0x00000000)
#define	TypeXQuestObjective				xClassType(0x01100000)
#define	TypeXQuest						xClassType(0x01200000)
#define TypeXStateBase					xClassType(0x01300000)
#define	TypeXSkillBase					xClassType(0x01400000)
#define	TypeXGameMap					xClassType(0x01500000)
#define	TypeXGameObject					xClassType(0x01600000)
#define		TypeXCharactor				xClassType(0x02610000)

#define TypeXPacketBag					xClassType(0x01700000)  // 包裹或者背包
#define TypeXGoods						xClassType(0x01800000)  // 物品
#define TypeXStateBaseClock				xClassType(0x01900000)
