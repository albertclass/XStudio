#pragma once
#ifndef _XCHARACTOR_H_
#define _XCHARACTOR_H_
...
namespace XGC
{
	...
	public:
		...
		/// [8/24/2009 Albert]
		//////
		ActorStatus GetActorStatus()const { return ActorStatus( GetAttrValue<xgc_byte>( attrActorStatus ) ); }
	...
	protected:
		...
		{
			Trigger( Trigger_ActorEvent, hAttacker, (xgc_uintptr) lpContext, TriggerCode_ActorDead );
		...
		{
			Trigger( Trigger_ActorEvent, 0, (xgc_uintptr) lpContext, TriggerCode_ActorRelive );
		}
