...
namespace xgc
{
	namespace common
	{
		...
		extern "C"
		{
			int COMMON_API optind = 1;
			int COMMON_API opterr = 1;
			int COMMON_API optopt = '?';
			...
			int _getopt_internal( int argc, char *const *argv, const char *optstring, const struct option *longopts, int *longind, int long_only, int posixly_correct )
			{
				...
				result = _getopt_internal_r( argc, argv, optstring, longopts, longind, long_only, &getopt_data_a, posixly_correct );
