...
namespace XGC
{
	namespace net
	{
		...
		{
		public:
			CServerSession( IMessageQueue *pMessageQueue, const PacketProtocal* pProtocal );
			~CServerSession(xgc_void);
		...
		INetworkSession* create_server_handler( xgc_uintptr lParam );
	}
}