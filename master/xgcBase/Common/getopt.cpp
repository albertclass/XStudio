...
namespace XGC
{
	namespace common
	{
		...
		extern "C"
		{
			int COMMON_API XGC::common::optind = 1;
			int COMMON_API XGC::common::opterr = 1;
			int COMMON_API XGC::common::optopt = '?';
