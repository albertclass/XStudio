...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='gate',
  syntax='proto3',
  serialized_pb=_b('\n\ngate.proto\x12\x04gate\"/\n\tlogin_req\x12\x10\n\x08username\x18\x01 \x01(\t\x12\x10\n\x08password\x18\x02 \x01(\t\"\\\n\tlogin_ack\x12\x0e\n\x06result\x18\x01 \x01(\x05\x12\x0f\n\x07user_id\x18\x02 \x01(\x04\x12\x12\n\nchat_token\x18\x03 \x01(\t\x12\x0c\n\x04host\x18\x04 \x01(\t\x12\x0c\n\x04port\x18\x05 \x01(\r\"\x1d\n\nlogout_req\x12\x0f\n\x07user_id\x18\x01 \x01(\x04*^\n\x0bGATE_MSG_ID\x12\x12\n\x0eGATE_MSG_BEGIN\x10\x00\x12\x12\n\x0eGATE_LOGIN_REQ\x10\x01\x12\x12\n\x0eGATE_LOGIN_ACK\x10\x02\x12\x13\n\x0fGATE_LOGOUT_REQ\x10\x03\x62\x06proto3')
)
...
_GATE_MSG_ID = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GATE_LOGIN_REQ', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GATE_LOGIN_ACK', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GATE_LOGOUT_REQ', index=3, number=3,
      options=None,
      type=None),
  ],
...
_LOGIN_ACK = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host', full_name='gate.login_ack.host', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='port', full_name='gate.login_ack.port', index=4,
